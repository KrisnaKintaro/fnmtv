...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* ── TOMBOL AKSI VERDICT (di kolom aksi, khusus pending) ── */
        .act-approve {
            display: inline-flex;
            align-items: center;
            gap: 4px;
        ...
        .modal-article-body p:last-child {
            margin-bottom: 0;
        }
