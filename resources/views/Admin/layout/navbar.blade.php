...
<div class="mobile-search-wrap">
    <div class="search-box">
        ...
        <input type="text" class="mobile-search-input" placeholder="Cari data...">
    </div>
</div>
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        if (desktopSearch && mobileSearch) {
            ...
            mobileSearch.addEventListener('input', function() {
                ...
                desktopSearch.dispatchEvent(keyupEvent);
            });

            // Sebaliknya, jika inputan desktop dimanipulasi/clear, samakan ke inputan HP
