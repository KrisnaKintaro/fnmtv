...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Merriweather:wght@400;700;900&family=Source+Sans+3:wght@300;400;500;600;700&family=JetBrains+Mono:wght@400;500;600&display=swap" rel="stylesheet">
    ...
    <style>
        *, body, html, p, div, span, table, td, th, input, select, textarea, button {
        ...
        code, .slug-text, #inputSlugKategori, [style*="JetBrains Mono"] {
            font-family: 'JetBrains Mono', monospace !important;
        }
    </style>
    @yield('css')

    {{-- ── Sidebar toggle harus tersedia SEBELUM DOM & script lain terbaca ── --}}
    <script>
        // Restore state sidebar dari sesi sebelumnya (opsional tapi UX lebih smooth)
        (function () {
        ...
        function toggleSidebar() {
            ...
            // Simpan state di localStorage supaya konsisten antar halaman
...
<body>
    ...
    <script>
        ...
        /* ── RESTORE STATE SIDEBAR: Apply state dari localStorage saat DOM siap ── */
        (function () {
            if (localStorage.getItem('sidebarClosed') === '1') {
