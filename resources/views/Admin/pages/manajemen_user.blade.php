...
@section('css')
    <style>
        ...
        .tab-pills {
            ...
            /* Background kontainer biar kayak segment control */
            padding: 4px;
            border-radius: 10px;
            width: fit-content;
        }
        ...
        .tab-p.active {
            ...
            /* Tombol aktif jadi putih bersih */
            color: #1e293b;
            /* Teks lebih gelap/tegas */
            box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);
        }

        /* Variasi warna indikator status kalau mau lebih spesifik (Opsional) */
    ...
    <div id="page-users" class="page active" data-admin-id="{{ Auth::id() }}">
        ...
        <div class="card">
            <div class="card-hd">
                ...
                <div class="tab-pills" style="display:flex; gap:8px;">
...
@section('js')
    <script>
        ...
        function filterUserStatus(status) {
            // Pindahin class active biar UI-nya snappy
        ...
        function applyUserFilter() {
            // Perbaikan: Hapus spasi di antara tanda tanya dan titik (?.value)
