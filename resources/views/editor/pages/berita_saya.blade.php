        ...
        <div class="page-header">
            <div id="backButtonContainer" class="back-button" style="display:none;">
                <button class="btn btn-ghost btn-sm btn-pill"
                    onclick="showPage('my-news', document.querySelectorAll('.s-item')[1])" style="gap:6px;">
            ...
            <div>
                <div class="form-card" style="margin-bottom:16px;">
                    ...
                    <div class="field">
                        ...
                        <input type="text" placeholder="judul-berita-menarik"
            ...
            <table id="newsTable">
                ...
                <tbody id="newsBody">
                    ...
                    <tr data-status="pending">
                        ...
                        <td>
                            <div class="act-btns">
                                <div class="ico-btn" style="opacity:.4;cursor:not-allowed;"
                                    title="Tidak dapat diedit saat Pending">✏️</div>
                            </div>
                        </td>
                    </tr>
                    ...
                    <tr data-status="rejected">
                        ...
                        <td>
                            ...
                            <div class="reject-reason">
                                <span>⚠️</span>
                                <div><b>Alasan Penolakan:</b>Data kurs belum diverifikasi dari sumber resmi Bank Indonesia.
                                    Harap perbarui dengan data terkini.</div>
                            </div>
                        </td>
                        <td><span class="badge" style="background:#fde8e8;color:var(--red);">Ekonomi</span></td>
                        ...
                        <td>
                            <div class="act-btns">
                                <div class="ico-btn" title="Revisi &amp; Edit" onclick="editFromTable('write-news')">✏️
                                </div>
                                <div class="ico-btn" title="Hapus" onclick="confirmDelete(this)">🗑</div>
                            </div>
                        </td>
                    ...
                    <tr data-status="rejected">
                        ...
                        <td>
                            ...
                            <div class="reject-reason">
                                <span>⚠️</span>
                                <div><b>Alasan Penolakan:</b>Judul kurang spesifik dan isi artikel perlu diperlengkap dengan
                                    kutipan dari pejabat terkait.</div>
                            </div>
                        </td>
                        <td><span class="badge" style="background:#fde8e8;color:var(--red);">Politik</span></td>
                        <td><span class="badge b-reject">Ditolak</span></td>
            ...
            $.ajax({
                ...
                success: function(res) {
                    ...
                    res.data.forEach(item => {
                        rows += `
                <tr data-status="${item.status_berita}">
                    <td><div class="tbl-img">📰</div></td>
                    <td>
                        <div class="tbl-title">${item.judul_berita}</div>
                        <div class="tbl-meta">${item.slug}</div>
                    </td>
                    <td><span class="badge">${item.kategori}</span></td>
                    <td><span class="badge">${item.status_berita}</span></td>
                    <td>-</td>
                    <td>
                        <div class="act-btns">
                            <div class="ico-btn" onclick="editBerita(${item.id})">✏️</div>
                            <div class="ico-btn" onclick="hapusBerita(${item.id}, this)">🗑</div>
                        </div>
                    </td>
                </tr>
                `;
