...
Route::prefix('editor')
    ...
    ->group(function () {
        ...
        Route::get('/kategori/daftarKategori', [KategoriController::class, 'getDaftarKategori']);
        Route::prefix('berita')->group(function () {
            Route::get('/daftarBerita',          [BeritaController::class, 'getDaftarBerita']);
            Route::get('/detailBerita/{id}',     [BeritaController::class, 'detailBerita']);
            Route::post('/buatBerita',           [BeritaController::class, 'buatBerita']);
            Route::post('/editBerita/{id}',      [BeritaController::class, 'editBerita']);
            Route::patch('/kirimKeRedaksi/{id}', [BeritaController::class, 'kirimKeRedaksi']);
            Route::delete('/hapusBerita/{id}',   [BeritaController::class, 'hapusBerita']);
        });
    });
